...
\abstract{We explore aspects of matter in relation to information theory.  Matter is considered to have a distinct sampling rate and channel capacity, akin to a signal.  We refer to this as a ``matter channel''.  We demonstrate how matter channels can be effectively represented by Dirac spinors.  Finally, we show how to think of proper time as an emergent property of matter.}
